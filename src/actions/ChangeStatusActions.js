...
export const updateDealStatus = (is_delivered, packId, planId, last_comment ) => {
return function (dispatch) {
    const data = { is_delivered: is_delivered ,last_comment: last_comment };
    const request = {
      method: 'PUT',
      body: JSON.stringify(data),
      headers: { 'Content-Type': 'application/json' },
    }
    console.log('REQUEST',UPDATE_DEAL_STATUS+""+packId+"/"+planId, request);
    fetch(UPDATE_DEAL_STATUS+""+packId+"/"+planId, request)
