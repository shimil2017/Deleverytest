...
import { View,Text,TextInput,ScrollView,TouchableOpacity,Image,Picker,AsyncStorage, ActivityIndicator, FlatList } from 'react-native';
...
import { getPackagesList, getPackagesListExplore } from '../actions/PackagesListActions';
import { Actions } from 'react-native-router-flux';
const mapStateToProps = ({ TravelersListReducer, PackagesListReducer }) => {
...
const mapDispatchToProps = dispatch => {
  return bindActionCreators({ getTravelerList, getPackagesList, getPackagesListExplore }, dispatch);
